...
import com.example.bluetoothapp.navigation.AppNavigationDrawer
...
fun MainScreen(
    ...
    // Get the current route for highlighting the active nav item
    ...
    // Get unacknowledged alerts count for badge
    val unacknowledgedAlerts by crashAlertViewModel.unacknowledgedAlerts.collectAsState()
    val unacknowledgedCount = unacknowledgedAlerts.size
    
    // Create the navigation drawer with the content
    AppNavigationDrawer(
        ...
        onNavigate = { route ->
            navController.navigate(route) {
                ...
                // Avoid duplicate destinations on the stack
